...
def save_training_checkpoint(
    ...
    if cfg.use_hn_lora:
        adapter_dir = checkpoint_dir / "hn_lora_adapter"
    else:
    ...
    if distributed_state.is_main_process:
        ...
        if cfg.use_hn_lora:
            ...
            torch.save(hn_hypernet.state_dict(), adapter_dir / "hypernet_state.pt")
            ...
            with open(adapter_dir / "hn_lora_config.json", "w") as f:
    ...
    if cfg.use_lora and not cfg.use_hn_lora and cfg.merge_lora_during_training:
