...
CUDA_VISIBLE_DEVICES=0 python experiments/robot/libero/run_libero_eval.py \
  --pretrained_checkpoint finetune_saves/openvla-oft/20250919_103236+openvla-7b+libero_goal_no_noops+b1+lr-0.0005+hn_lora-r4--image_aug--hyperlora--100_chkpt/ \
